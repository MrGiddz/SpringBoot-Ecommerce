...
public class AuthenticationController {
    ...
    /**
     * The userService created above is initialized in this constructor
     ...
     * It creates a new user by calling the registerUser method from the instance of UserService (userService) created above
