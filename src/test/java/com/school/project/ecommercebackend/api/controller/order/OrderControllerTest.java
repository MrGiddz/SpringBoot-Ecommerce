...
public class OrderControllerTest {
    ...
    public void testUserAAuthenticatedOrderList() {
        testAuthenticatedListBelongsToUser("UserA");
    }

    @Test
    @WithUserDetails("UserB")
    public void testUserBAuthenticatedOrderList() {
        testAuthenticatedListBelongsToUser("UserB");
    }

    private void testAuthenticatedListBelongsToUser(String username) {
        try {
            mvc.perform(get ("/orders")).andExpect(status().is(HttpStatus.OK.value ()))
                    .andExpect (result -> {
    ...
    @Test
    public void testUnauthenticatedOrderedList () throws Exception {
